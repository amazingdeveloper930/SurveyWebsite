$(document).ready(function () {
	...
	$(document).on('click', ".add-more", function () {
		...
		$(this).parents(".variantai").find(".option:last .btn-spot").html('<button type="button" class="btn btn-default remove-it"><span class="glyphicon glyphicon-minus"></span> Remove</button>');
	});
