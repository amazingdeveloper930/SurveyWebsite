...
Route::group(['namespace' => 'backend'], function () {
    ...
    Route::get('admin/sponsored', ['as' => 'sponsored', 'uses' => 'DashboardController@sponsored']);
    Route::get('admin/dashboard', ['as' => 'dashboard', 'uses' => 'DashboardController@index']);

    Route::get('admin/setsurveylangauge/{id}/{language}', ['as' => 'setsurveylangauge', 'uses' => 'DashboardController@setsurveylangauge']);

    Route::get('search', ['as' => 'search.user', 'uses' => 'UsersController@search']);
    // Dashboard Credit Filter for campaign - Ranveer
    Route::get('admin/dashboard/search', ['as' => 'search.dashboard', 'uses' => 'DashboardController@scredit']);
    Route::get('admin/dashboard/delete/{id}', ['as' => 'destroy.dashboard', 'uses' => 'DashboardController@destroy']);
    Route::get('admin/dashboard/acsurvey/{id}', ['as' => 'viewCampaign.dashboard', 'uses' => 'DashboardController@viewCampaign']);
    Route::get('admin/dashboard/survey/{id}/profile', ['as' => 'survey.profile', 'uses' => 'DashboardController@viewCampaignProfile']);
    Route::get('admin/dashboard/stats', ['as' => 'survey.stats', 'uses' => 'DashboardController@stats']);

    Route::post('admin/dashboard/', ['as' => 'addCredit.dashboard', 'uses' => 'DashboardController@addCredit']);
    ...
    //socialshare
    Route::get('admin/socialshare/survey', ['as' => 'socialshare.survey', 'uses' => 'SocialShareController@survey']);
    Route::get('admin/socialshare/general', ['as' => 'socialshare.general', 'uses' => 'SocialShareController@general']);

    Route::post('admin/add_free_credit/{id}', ['as' => 'socialshare.addcredit', 'uses' => 'SocialShareController@add_free_credit']);
...
Route::get('/google211415a426217b64.html', ['as' => 'google', 'uses' => 'frontend\HomeController@google']);
...
Route::get('surveys', ['as' => 'pages.all-serveys', 'uses' => 'frontend\PagesController@all_surveys']);
...
Route::post('cardinity', ['as' => 'cardinity_money', 'uses' => 'CardinityController@makePayment']);

Route::group(['namespace' => 'frontend'], function () {
    // Credit cardiniti
    Route::post('cardform', ['as' => 'cardform', 'uses' =>'CreditsController@CardForm']);
    // Payments
    ...
    Route::get('mano-anketos', ['as' => 'campaigns.mano', 'uses' => 'CampaignsController@mano']);
    ...
    Route::get('share-survey/{id}', ['as' => 'campaigns.share', 'uses' => 'CampaignsController@share']);

    Route::get('facebookreport/{id}', ['as' => 'campaigns.facebookreport', 'uses' => 'CampaignsController@reportFacebookShare']);

    Route::get('facebookreport_site', ['as' => 'campaigns.facebookreport_site', 'uses' => 'SocialShareController@reportFacebookShare_site']);

    Route::get('/trustpilot/post', ['as'=> 'campaigns.trustpilot', 'uses'=>'SocialShareController@post_trustpilot']);

    Route::get('/sitejabber/post', ['as'=> 'campaigns.sitejabber', 'uses'=>'SocialShareController@post_sitejabber']);
    
    Route::get('/alternativeto/post', ['as'=> 'campaigns.alternativeto', 'uses'=>'SocialShareController@post_alternativeto']);

    Route::get('survey/setlanguage', ['as'=>'campaigns.setlanguage', 'uses'=>'CampaignsController@setCampaignlanguageAccordingtoUser']);
    ...
    Route::post('survey/{id}', ['as' => 'campaigns.answer.store', 'uses' => 'CampaignsController@store_answer']);
    ...
    // yusuf j
    Route::get('survey/{id}', ['as' => 'campaigns.answer', 'uses' => 'CampaignsController@answer']);
    // Anketos rezultatai
    ...
    // Paskyros nustatymai
    Route::get('account-settings', ['as' => 'account.index', 'uses' => 'AccountController@index']);
    Route::post('account-settings', ['as' => 'account.update', 'uses' => 'AccountController@update']);
    Route::get('account-updatepolls', ['as'=>'account.updatepoll', 'uses' => 'AccountController@update_polls']);
    Route::get('get-available-poll', ['as'=>'account.availablepoll', 'uses' => 'AccountController@get_available_poll']);
    ...
    Route::get('share_facebook/{id}', ['as' => 'share_on_facebook', 'uses' => 'CampaignsController@handleFacebookShare']);
