		                        ...
		                        <div class="tile-widget">
		                            <table class="table">
		                                ...
		                                <tbody class="sblock">
		                                	@for($i = 1; $i <= 5; $i++)
		                                    <tr>
		                                        <td>{{ $i * 5 / Credits::credits('one_credits') }} EUR</td>
		                                        <td>{{ $i * 5 }}</td>
		                                        <td>
		                                        	<form method="POST" id="payment-form" action="{!! URL::to('paypal') !!}" style="margin: 0;">
														...
														<input type="hidden" name="amount" value="{{ ($i * 5 / Credits::credits('one_credits')) }}">
		                                        ...
		                                        <!-- <td><a href="#" id="myBtn" class="btn btn-success btn-border btn-rounded-20 btn-ef btn-ef-4 btn-ef-4c mb-10" name="price"><i class="fa fa-dollar"></i> Buy Now</a></td> -->
		                                    </tr>
		                                    @endfor                                    
		                                </tbody>
		                            </table>
