...
<section id="content">
    <div class="page page-profile">
        <div class="pageheader">
            <h2>Add question to
				<small>"{{ $entry->title }}" @lang('frontend/common.Survey')</small></h2>
        </div>                   
                                        ...
                                        <div class="wrap-reset">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-7" style="margin-left: 10px;">
                                                    <label style="padding: 0px 20px;" class="form-group" for="general-information">@lang('frontend/campaigns.Question')</label>
													...
													<label style="padding: 0px 20px;" class="form-group" for="general-information">@lang('frontend/campaigns.Answers')</label>
													<div class="variantai">
															...
															@foreach (Request::old('option') as $key => $option)
																<div class="form-group option">
																	...
																	<div class="col-sm-3 btn-spot">
																		@if ($key == 0)
																			<button type="button" class="btn btn-default add-more"><span class="glyphicon glyphicon-plus"></span> @lang('frontend/campaigns.Add_more')</button>
																		@else
																			<button type="button" class="btn btn-default remove-it"><span class="glyphicon glyphicon-minus"></span> @lang('frontend/campaigns.Remove')</button>
																		@endif
																	</div>
																</div>
															@endforeach
													...
													<div class="variantai">
														...
														@if($type != 'matrix')
															<p>Reitingavimas (x)</p>
														@else
																<label style="padding: 0px 20px;" class="form-group" for="general-information">@lang('frontend/campaigns.Rating_choice')</label>
														@endif
                                            ...
                                            <div class="pull-right hidden-sm hidden-xs">
                                                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> @lang('frontend/campaigns.Add_questions')</font></font></button>
                                                <a href="{{ route('campaigns.questions', $entry->id) }}" class="btn btn-default add-question-cancel">@lang('frontend/campaigns.Cancel')</a>
                                            </div>
                                            {{ Form::close() }}
                                        </div>
                                    </div>                                    
