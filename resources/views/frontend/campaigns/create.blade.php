                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 15px; padding-bottom: 10px !important;">
                                                            <label>@lang('frontend/layouts.Lanugage')</label>
                                                            <div class = "poll-answer">
                                                                <label class="inline-block hint-text  col-sm-12">
                                                                {{Form::select('language', $language_list , null, ['class' => 'form-control ']) }}
                                                                </label>
                                                            </div>
                                                           
                                                        </div>
                                                        <div class="form-group {{ $errors->first('respondents', 'has-error') }}">
                                                           <label for="upload a picture" style="margin-left: 0px !important;">@lang('frontend/campaigns.Upload_image')</label>
                                                        ...
                                                        <div class="form-group {{ $errors->first('respondents', 'has-error') }}">
                                                           <div class="col-sm-9 col-sm-offset-3" style="margin-left: 2% !important;
                                                                ...
                                                                <div class="checkbox"> 
                                                                    <label>
                                                                    	{{ Form::checkbox('respondents', 1) }} @lang('frontend/campaigns.Show_results_to_respondents')
                                                                    </label>
                                                                </div>
                                                                {!! $errors->first('respondents', '<label class="control-label">:message</label>') !!}
                                                                 <div class="pull-left">
                                                    <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> @lang('frontend/campaigns.Save')</font></font></button>
                                                </div>
                                                            </div>
                                                        </div>
