                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
														...
														<div class="alert alert-{{ ( $errors->first('respondents') ? 'danger' : 'warning') }}">
															...
															@if ($entry->public)
																<p>
																	You have <strong>{{ $entry->credits }}</strong> unused credits for which can promote your survey.
																	One answer price of this survey is <strong>{{ config('settings.featured_credits') }}</strong>.
																	Enter quantity of answers, which you want to get during this survey advertising.
																</p>				
...
<a href="{{ route('campaigns.questions', $entry->id) }}" class="btn btn-primary" style="border-color:#16977d!important;; background-color: #16977d!important;">Result</a>
                                            ...
                                            <div class="pull-right" style="margin-top:5px!important; margin-right:50px !important;">
                                                ...
                                                <button type="submit" class="btn btn-primary launchbutton">
