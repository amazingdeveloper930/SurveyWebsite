        ...
        @if (auth()->guard('admin')->check())
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="{{ request()->is('admin/dashboard/stats') ? 'active' : '' }}"><a href="{{ route('survey.stats') }}">Statistics</a></li>
                    <li class="{{ request()->is('admin/sponsored*') ? 'active' : '' }}"><a href="{{ route('sponsored') }}">Sponsored Surveys</a></li>
                    <li class="{{ request()->is('admin/socialshare*') ? 'active' : '' }} dropdown">
                        
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Soc.shares
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                          <li><a href="{{ route('socialshare.survey') }}">Survey</a></li>
                          <li><a href="{{ route('socialshare.general') }}">General</a></li>
                        </ul>
                    </li>
