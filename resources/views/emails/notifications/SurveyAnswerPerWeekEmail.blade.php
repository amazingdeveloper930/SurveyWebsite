    ...
    <div style="background-color:#E3E5E7;">
      ...
      <![endif]-->
        <div style="margin:0 auto;max-width:600px;background:#222228;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#222228;">
                <tbody>
                    <tr>
      ...
      <![endif]-->
                            <div aria-labelledby="mj-column-per-80" class="mj-column-per-80" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td align="center" style="word-break:break-word;font-size:0px;padding-bottom:30px;padding-top:30px;">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <p style="color:#fff;font-size:37px;text-transform: capitalize;">
                                                                    Poll Animal
                                                                </p>
                                                            </td>
                                                        </tr>
      ...
      <![endif]-->
        <div style="margin:0 auto;max-width:600px;background:white;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:white;">
                <tbody>
                    <tr>
                        <td style="text-align:center;vertical-align:top;font-size:0px;padding:20px 0px;">
                            <!--[if mso | IE]>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td align="left" style="word-break:break-word;font-size:0px;padding:0px 25px 15px;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;">
                                            Hello, this week your survey <br/>
                                              @foreach($email_data as $data)
                                               <strong>{{$data['survey_name']}} </strong>get {{$data['survey_count']}} responses
                                               <br/>
                                              @endforeach
                                              Come and investigate results. You can also promote your survey and get even more responses.<br/>
                                              Quick log in <a href="{{$link}}"> here</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            
                                            <td align="left" style="word-break:break-word;font-size:0px;padding:0px 25px 15px;">
                                                <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;">
                                                    We want to remind you, that you can get even more responses by promoting your survey
      ...
      <![endif]-->
        <div style="margin:0 auto;max-width:600px;background:#F5F7F9;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#F5F7F9;">
                <tbody>
                    <tr>
                        <td style="text-align:center;vertical-align:top;font-size:0px;padding:20px 0px;">
                            <!--[if mso | IE]>
      ...
      <![endif]-->
                            <div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td align="center" style="word-break:break-word;font-size:0px;padding:0px 20px;">
